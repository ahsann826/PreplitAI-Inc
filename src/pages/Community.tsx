    ...
    <section className="max-w-7xl mx-auto px-6 pt-20 pb-16">
      <div className="text-center mb-16">
        <h1 className="text-5xl md:text-6xl font-bold text-black dark:text-white mb-6">
          Join the <span className="text-red-600 dark:text-red-500">Community</span>
        </h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        {communityResources.map((resource, i) => {
          ...
          const colorClasses = {
            blue: "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-800",
            purple: "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-800",
            pink: "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-800",
            green: "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-800"
          };
          return (
            <Card key={i} className={`border-2 ${colorClasses[resource.color as keyof typeof colorClasses]}`}>
              <CardHeader>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                      <span className="px-2 py-1 bg-blue-100 dark:bg-red-900 text-blue-700 dark:text-blue-300 rounded-full text-xs">
                        {event.type}
                      </span>
      ...
      <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
        ...
        <div>
          <div className="text-4xl font-bold text-red-600 dark:text-red-500 mb-2">250+</div>
          <div className="text-sm text-gray-600 dark:text-gray-400">Events Hosted</div>
        </div>
        <div>
          <div className="text-4xl font-bold text-red-600 dark:text-red-500 mb-2">800+</div>
