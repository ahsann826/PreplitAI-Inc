  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-16 overflow-hidden">
        ...
        <div className="absolute top-0 -left-48 w-96 h-96 bg-red-600/10 dark:bg-red-600/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 -right-48 w-96 h-96 bg-red-900/10 dark:bg-red-900/5 rounded-full blur-3xl" />
        
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 dark:bg-red-900/30 border border-red-200/50 dark:border-red-800/30 mb-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-black dark:text-white mb-6 leading-tight">
            ...
            <br />
            <span className="text-red-600 dark:text-red-500">modern learning</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {capabilities.map((cap, i) => (
            <div key={i} className="group relative p-8 rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-300 hover:shadow-2xl">
              <div className={`absolute inset-0 rounded-3xl ${cap.gradient} opacity-0 group-hover:opacity-5 transition-opacity`} />
              <div className="relative z-10">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-2xl ${cap.gradient} mb-6 shadow-lg`}>
