...
const Credits = () => {
  ...
  const getTransactionColor = (type: string) => {
    switch (type) {
      case 'PURCHASE':
        return 'bg-blue-50 dark:bg-red-900 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800';
      case 'DEBIT':
          ...
          <Card className={`border-2 ${isLow ? 'border-orange-200 dark:border-orange-800' : 'border-blue-200 dark:border-blue-800'}`}>
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                <div className={`p-3 rounded-lg ${isLow ? 'bg-orange-100 dark:bg-orange-950' : 'bg-blue-100 dark:bg-red-900'}`}>
